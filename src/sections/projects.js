...
import { ProjectsToHome } from '../components/ProjectsToHome';
...
const GridItem = () => {
  ...
  return (
    <Box direction={["column", "column", "column", "row"]}
      w="full"
      h="full"
      p={10}
      spacing={10}
      ...
      >
      <Grid
        templateColumns={['repeat(1, 1fr)','repeat(2, 1fr)', 'repeat(2, 1fr)', 'repeat(3, 1fr)']} gap={6}>
